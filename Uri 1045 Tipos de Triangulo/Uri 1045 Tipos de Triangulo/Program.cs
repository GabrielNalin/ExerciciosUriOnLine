...
namespace Uri_1045_Tipos_de_Triangulo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                // primeiro vamos testar as 3 possibilidades em relação a angulos
                if (A * A == B * B + C * C)
                {
                ...
                // agora vamos testar se pode ser equilatero ou isisceles
                if (A == B && B == C)
                {
